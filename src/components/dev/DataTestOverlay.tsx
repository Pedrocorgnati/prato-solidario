...
export function DevDataTestOverlay() {
  ...
  // Atualizar posicoes dos overlays no scroll e resize
  useEffect(() => {
    if (!isActive) return
  ...
  // Camada 1: verificacao de ambiente — APOS todos os hooks
  if (process.env.NODE_ENV !== 'development') {
    return null
  }

  // Aguarda posicao inicial (SSR safety)
  if (!pos) return null
